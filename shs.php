...
$sql = "SELECT student_id, profile, CONCAT(first_name, ' ', middle_name, ' ', last_name) AS full_name, 
               address, email, phone, edu_level, track, grade_level, session AS semester, 'Active' AS status 
        FROM shs_students";
...
<body>
    ...
    <div class="sidebar-menu">
            <h2 id="dashboard-title" >SHS Department</h2>
        <ul class="nav-list">
    ...
    <div class="main-container">
        ...
        <div class="main-container-header">
            <div class="sub-main-container-header start">
                <i class="fa-solid fa-bars-progress"></i> <span id="department-name">Senior High School Department</span>
            </div>
        </div>
    ...
    <script src="./assets/js/appss.js"></script>
